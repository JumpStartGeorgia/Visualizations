ka =
{
   ...
   description: "სამხრეთ კავკასიის ქვეყნებში ოჯახები ირჩევენ, რომ მათი ახალშობილი იყოს ბიჭი და არა გოგო. ვაჟის პრეფერენციის გამო, სომხეთი, საქართველო და აზერბაიჯანი ყოველწლიურად ათასობით გოგოს კარგავენ. სელექციური აბორტების გამო, სხვადასხვა შეფასების მიხედვით, სამხრეთ კავკასიაში ბოლო 20 წლის განმავლობაში 154 ათასი გოგო არ დაიბადა. ხშირად მათ \"გამქრალ ქალებს\" ეძახიან. რა შეიძლება მოხდეს, თუ არაფერი შეიცვლება?",
   url: "",
   ...
   charts:
   {
      ...
      bar_chart: {
         ...
         base_mark: "ყოველ 100 გოგოზე დაბადებული ბიჭების რაოდენობა ბუნებრივი შობადობის პირობებში",
